...
- <kbd>hyper</kbd> + <kbd>b</kbd> to open Safari ("B" for "Browser")
- <kbd>hyper</kbd> + <kbd>c</kbd> to open Discord ("C for "Chat")
- <kbd>hyper</kbd> + <kbd>d</kbd> to open [2Do](https://www.2doapp.com/mac) ("D" for "Do!" ... or "Done!")
